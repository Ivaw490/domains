...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    resize($path, $path_mini, 200, 125);//создаем уменьшеную версию изображения и кладем ее в $path_mini
    ...
    header("Location: /index.php");//для нормальной работы обновления страницы
}
